...
class GetLastWeekSystolicRecordsUseCase(
    ...
    override suspend fun invoke()
        ...
        return flow {
            ...
            bloodPressureRepository
                .getLatestSystolicMeasurement().collect { status ->
                    ...
                    when (status) {
                        ...
                        is Status.Success -> {
                            ...
                            if (status.toData()?.statusCode == 200) {
                                ...
                                for (key in (status.toData()?.body?.data ?: emptyMap()).keys.reversed()) {
...
}//END GetLastWeekSystolicRecordsUseCase