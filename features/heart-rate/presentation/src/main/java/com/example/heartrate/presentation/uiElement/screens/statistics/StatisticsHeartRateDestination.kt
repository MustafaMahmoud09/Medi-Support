...
package com.example.heartrate.presentation.uiElement.screens.statistics
...
fun NavHostController.navigateToStatisticsHeartRateDestination() {
    ...
    navigate(
        ...
        popUpTo(
            route = com.example.heartrate.presentation.uiElement.screens.measurement.MEASUREMENT_HEART_RATE_DESTINATION_ROUTE
        ) {
            inclusive = true
        }//end popUpTo
