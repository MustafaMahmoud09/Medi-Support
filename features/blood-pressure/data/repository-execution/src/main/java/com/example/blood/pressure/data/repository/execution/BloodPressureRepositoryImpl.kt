...
class BloodPressureRepositoryImpl(
                        ...
                        when (status) {
                            ...
                            is Status.Success -> {
                                ...
                                if (status.toData()?.statusCode == 200) {
                                    ...
                                    bloodPressureRepositoryHelper.cacheLatestBloodPressureRecord(
                                        bloodPressureRecord = status.toData()?.body?.data as LatestBloodPressureDto,
                                        userId = userAuthId
                                    )
    ...
    override suspend fun getLatestSystolicMeasurement()
    ...
    override suspend fun getLatestDiastolicMeasurement()
            : Flow<Status<EffectResponse<IDescBloodPressureResponseDto>>> {
