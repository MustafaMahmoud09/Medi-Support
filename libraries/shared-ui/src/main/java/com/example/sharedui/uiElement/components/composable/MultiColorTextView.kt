...
@Composable
fun MultiColorTextView(
    dimen: CustomDimen,
    theme: CustomTheme,
    parentText: String,
    subTexts: Array<String>,
    subTextsColors: Array<Color>,
    ...
    if (subTextsColors.size == subTexts.size && subTextsColors.isNotEmpty()) {
        ...
        val aboutInfoColor = AnnotatedString.Builder(parentText).apply {
            ...
            addStyle(
                style = SpanStyle(color = parentTextColor),
                start = 0,
